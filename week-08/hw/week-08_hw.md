...
![Preview](assets/cs171_w8_hw_preview.png?raw=true "D3 Projections")
...
The structure of the file is slightly more sophisticated than the ones you've seen so far. This
 file contains Covid data from the year 2020 and has been cleaned up be the CS171 staff. There are
...
- **covid_data_22** is the latest Covid data from `HealthData.gov`. You don't need to use this file in
 this homework. This is just for people who have some extra time on their hands and would like to
  play around with the latest Covid data. Since the dataset hasn't been cleaned by the CS171 staff
  , you might encounter some minor bugs. Just by looking at summations in the data table for this
...
![W08HW-templatePreview](assets/cs171_w8_hw_template.png?raw=true "W08HW-templatePreview")
...
![Preview](assets/cs171_w8_hw_map.png?raw=true "D3 Projections")
...
![Preview](assets/cs171_w8_hw_bars.png?raw=true "D3 Projections")
...
```
/submission_week_08_FirstnameLastname
    hw/
